...
const seed = {
  ...
  listeningHubItems: [
    base("listening-hub-academic-talk-detail", "academic-talk-detail-biology", "Academic Talk - Detail Practice", { description: "Topic-based listening route for stated detail questions in academic talks.", topicId: "topic-biology", taskTypeId: "task-academic-talk", subskillId: "sub-detail", difficultyId: "adaptive", lengthId: "standard", sessionMode: "practice", mediaProvider: "youtube", mediaUrl: "https://www.youtube.com/watch?v=ysz5S6PUM-U", durationSeconds: 1200, estimatedMinutes: 20, questionCount: 10, actionLabel: "Start Focused Practice", outline: [{ startSeconds: 0, title: "Introduction" }, { startSeconds: 180, title: "Main point" }, { startSeconds: 480, title: "Supporting details" }], transcript: [{ startSeconds: 0, text: "The lecture introduces the academic topic." }, { startSeconds: 180, text: "Listen for the stated details and examples." }] }),
    base("listening-hub-note-map-main-idea", "note-map-main-idea", "Note Map Main Idea", { sortOrder: 20, description: "Practice identifying the central point while organizing lecture notes.", topicId: "topic-campus-life", taskTypeId: "task-academic-talk", subskillId: "sub-main-idea", difficultyId: "medium", lengthId: "quick", sessionMode: "practice", mediaProvider: "youtube", mediaUrl: "https://www.youtube.com/watch?v=ysz5S6PUM-U", durationSeconds: 720, estimatedMinutes: 12, questionCount: 8, actionLabel: "Start Practice", outline: [{ startSeconds: 0, title: "Setup" }, { startSeconds: 120, title: "Central idea" }, { startSeconds: 360, title: "Note map" }], transcript: [{ startSeconds: 0, text: "Use the opening to predict the lecture direction." }, { startSeconds: 120, text: "The main idea connects all later details." }] }),
    base("listening-hub-academic-talk-section", "academic-talk-section-practice", "Academic Talk Section Practice", { sortOrder: 30, isPremium: true, description: "Longer listening route for section pacing and full academic talk stamina.", topicId: "topic-biology", taskTypeId: "task-academic-talk", subskillId: "sub-note-taking", difficultyId: "hard", lengthId: "extended", sessionMode: "exam", mediaProvider: "youtube", mediaUrl: "https://www.youtube.com/watch?v=ysz5S6PUM-U", durationSeconds: 1800, estimatedMinutes: 30, questionCount: 17, actionLabel: "Start Exam Practice", outline: [{ startSeconds: 0, title: "Directions" }, { startSeconds: 300, title: "Lecture body" }, { startSeconds: 1200, title: "Final synthesis" }], transcript: [{ startSeconds: 0, text: "This section follows exam pacing." }, { startSeconds: 300, text: "Take concise notes while listening." }] }),
  ],
  ...
  speakingTasks: [base('speaking-independent-role-models', 'independent-role-models-task', 'Independent Speaking Task 2', {
    taxonomy: tx('skill-speaking', 'task-independent-speaking', ['sub-fluency-coherence'], ['topic-campus-life'], 'level-intermediate', 'ctype-speaking-task', ['tag-timed']),
