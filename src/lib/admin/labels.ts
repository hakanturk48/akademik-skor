...
const labels: Record<string, string> = {
  ...
  listeningDifficultyId: "Zorluk", listeningLengthId: "Uzunluk", listeningSessionMode: "Oturum modu", listeningQuestionCount: "Soru sayısı", listeningActionLabel: "Buton etiketi",
