...
const labels: Record<string, string> = {
  ...
  listeningDifficultyId: "Zorluk", listeningLengthId: "Uzunluk", listeningSessionMode: "Oturum modu", listeningQuestionCount: "Soru sayısı", listeningQuestions: "Listening soruları", listeningActionLabel: "Buton etiketi",
