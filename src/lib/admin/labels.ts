...
const labels: Record<string, string> = {
  ...
  mediaProvider: 'Medya sağlayıcısı', mediaUrl: 'Medya bağlantısı', thumbnailUrl: 'Thumbnail bağlantısı',
  previewDurationSeconds: 'Önizleme süresi (saniye)', chapters: 'Bölümler', outline: 'Outline / zaman çizelgesi', transcript: 'Altyazı / transkript',
  resources: 'Kaynaklar', resourcesText: 'Kaynaklar', subtitle: 'Alt başlık', questionType: 'Soru türü', timeLimitSeconds: 'Süre sınırı', timeRemainingSeconds: 'Kalan süre', currentQuestionIndex: 'Aktif soru', answeredCount: 'Cevaplanan soru sayısı', markedCount: 'İşaretli soru sayısı', wordCount: 'Kelime sayısı', sourceLabel: 'Kaynak etiketi', passageTitle: 'Passage başlığı', passageParagraphs: 'Passage paragrafları', passageText: 'Passage metni', readingQuestionsText: 'Reading soruları', readingQuestions: 'Reading soruları', supportFocusTitle: 'Odak başlığı', supportFocusText: 'Odak metni', supportProgress: 'Odak ilerlemesi', reviewTitle: 'Tekrar başlığı', reviewTips: 'Tekrar ipuçları', reviewTipsText: 'Tekrar ipuçları', url: 'Bağlantı', sizeLabel: 'Boyut', premium: 'Premium',
  listeningHubItems: "Listening Parçaları", listeningTopicId: "Konu", listeningTaskTypeId: "Soru türü", listeningSubskillId: "Alt beceri",
  speakingTasks: 'Konuşma Görevleri', speakingTaskTypeId: 'Konuşma görev türü', speakingSubskillId: 'Konuşma alt becerisi', speakingTopicId: 'Konuşma konusu', speakingLevelId: 'Konuşma seviyesi',
  speakingPreparationSeconds: 'Hazırlık süresi', speakingResponseSeconds: 'Konuşma süresi', speakingChecklistText: 'Yanıt kontrol listesi', speakingCriteriaText: 'Puanlama ölçütleri', speakingBeforeStartText: 'Başlamadan önce',
  listeningDifficultyId: "Zorluk", listeningLengthId: "Uzunluk", listeningSessionMode: "Oturum modu", listeningQuestionCount: "Soru sayısı", listeningQuestions: "Listening soruları", listeningNoteSeed: "Not başlangıcı", listeningStudyTip: "Çalışma ipucu", listeningActionLabel: "Buton etiketi",
  subskillId: "Alt beceri", difficultyId: "Zorluk", lengthId: "Uzunluk", sessionMode: "Oturum modu", questionCount: "Soru sayısı", actionLabel: "Buton etiketi",
  adaptive: "Uyarlanabilir", easy: "Kolay", medium: "Orta", hard: "Zor", quick: "Kısa", standard: "Standart", extended: "Uzun", practice: "Pratik", exam: "Sınav",
...
const errors: Record<string, string> = {
  ...
  "Listening hub topic is required.": "Listening parçası için konu seçilmeli.",
  "Listening hub task type is required.": "Listening parçası için soru türü seçilmeli.",
  "Listening hub subskill is required.": "Listening parçası için alt beceri seçilmeli.",
  "Listening hub difficulty is invalid.": "Listening zorluğu geçerli değil.",
  "Listening hub length is invalid.": "Listening uzunluğu geçerli değil.",
  "Listening hub session mode is invalid.": "Listening oturum modu geçerli değil.",
  "Listening hub duration is required.": "Listening parçası için tahmini süre en az 1 dakika olmalı.",
  "Listening hub question count is required.": "Listening parçası için soru sayısı en az 1 olmalı.",
  ...
  "Listening preview duration cannot exceed media duration.": "Ücretsiz önizleme süresi dinleme parçası süresini aşamaz.",
  "Listening hub action label is required.": "Listening parçası için buton etiketi gerekli.",
  "Listening media URL is required before publishing.": "Yayınlamadan önce dinleme bağlantısı eklenmeli.",
  "A valid YouTube listening URL is required before publishing.": "Yayınlamadan önce geçerli bir YouTube dinleme bağlantısı eklenmeli.",
  "A valid Vimeo listening URL is required before publishing.": "Yayınlamadan önce geçerli bir Vimeo dinleme bağlantısı eklenmeli.",
  "A valid listening media URL is required before publishing.": "Yayınlamadan önce geçerli bir dinleme medya bağlantısı eklenmeli.",
  "Listening media duration is required.": "Dinleme parçası süresi en az 1 saniye olmalı.",
  "Listening outline must use time|title lines.": "Listening outline satırları zaman|başlık biçiminde olmalı.",
  "Listening transcript must use time|text lines.": "Listening transkript satırları zaman|metin biçiminde olmalı.",
  "Listening hub topic must belong to Listening.": "Seçilen konu Listening becerisine ait olmalı.",
  "Listening hub task type must belong to Listening.": "Seçilen soru türü Listening becerisine ait olmalı.",
  "Listening hub subskill must match the selected task type.": "Alt beceri seçilen Listening soru türüyle uyumlu olmalı.",
